namespace Task_11_07
{
    internal class Program
    {
         ...
         * целых чисел по ссылке и изменяет его элементы, 
         * увеличивая каждый на 1. Проверьте, изменился ли
        ...
        */
        ...
        /// <returns></returns>
        static void EnlargedArray(ref double[] num)
        {
